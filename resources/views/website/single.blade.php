          ...
          <div class="row align-items-end ">
            <div class="col-lg-12">
              ...
              <div class="intro">
                ...
                <div class="pb-4"><strong class="text-black">Posted on {{$car->created_at->format('Y-m-d')}}</strong></div>
              </div>
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                ...
                <li class="comment">
                    ...
                    <div class="comment-body">
                        <h3>{{$comment->name}}</h3>
                        <div class="meta"><a href="{{$comment->website}}">{{$comment->website}}</a> </div>
                        <p>{{$comment->message}}</p>
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form method="POST" action="{{ route('comment') }}"enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" hidden name="car_id" value="{{$car->id}}">
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="categories">
                ...
                <li><a href="#">{{$category->name}} <span>{{$category?->cars?->count() }}</span></a></li>
                @endforeach
              </div>
            </div>
            <div class="sidebar-box">
              <img src="{{asset('website/images/person_1.jpg') }}" alt="Free Website Template by Free-Template.co" class="img-fluid mb-4 w-50 rounded-circle">
