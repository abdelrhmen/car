...
@section('content')
<div class="hero" style="background-image: url('{{asset('website/images/hero_1_a.jpg')}}');">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 mx-auto">
          <a href="https://youtube.com/@magnet4294?si=myFqp1SNe-M0PP5s" class="d-flex align-items-center play-now mx-auto">
            <span class="icon">
